...
<h1>Ooopsy... ...this is my standard error page.</h1>
<h2>Error message: ${escape(title)}</h2>`;
});
...
var Zim = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.startZim === void 0 && $$bindings.startZim && startZim !== void 0)
    $$bindings.startZim(startZim);
  {
    {
  ...
  $$unsubscribe_store();
  return `${$$result.head += `<script src="${"https://zimjs.org/cdn/nft/00/zim.js"}" data-svelte="svelte-vvd5bl"><\/script>`, ""}
...
var Test = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<h1>ZIM als Svelte Komponente:</h1>

<h2>Size: ${escape(sizeA)}</h2>
<h2>Wert: ${escape(wert)}</h2>

<label for="${"size"}">Size:</label>
<input type="${"number"}" label="${"size"}"${add_attribute("value", sizeA, 0)}>

<label for="${"input"}">Wert:</label>
<input id="${"wert"}" type="${"text"}" label="${"input"}"${add_attribute("value", wert, 0)}>

${resp != "gugus" ? `<h3>${escape(resp)}</h3>` : ``}

<button>Make ZIM</button>


${validate_component(Zim, "Zim").$$render($$result, { this: zimcomponent }, {
      this: ($$value) => {
        zimcomponent = $$value;
        $$settled = false;
      }
