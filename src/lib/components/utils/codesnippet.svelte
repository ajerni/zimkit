<script>
    ...
    export let hideCopyButton = true;
  ...
  {:else}
    <div
      class:bx--snippet="{true}"
      class:bx--snippet--expand="{true}"
      class:bx--snippet--light="{false}"
      class:bx--snippet--no-copy="{true}"
      class:bx--snippet--wraptext="{true}"
      class:bx--snippet--single="{false}"
      class:bx--snippet--inline="{false}"
      class:bx--snippet--multi="{true}"
      class:bx--snippet--disabled="{false}"
      {...$$restProps}
      on:mouseover
      on:mouseenter
      on:mouseleave
    >
      <div
        ...
        class:bx--snippet-container="{false}"
